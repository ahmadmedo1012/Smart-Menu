# Smart Menu — Single Source of Truth
...
### Icon Files
- `public/brand-icon.png` — Internal logo (160×160 centered, transparent background, used across Header/Footer/Login/Owner sidebar)
- `public/favicon.png` — Tab icon (48×48)
- `public/icon-192.png` / `public/icon-512.png` — PWA icons
- All derived from `last_logo.png` (not in repo — regenerate with `python3 resize.py`)
