...
## Mandatory Execution Rules (STRICT)
...
- Full compliance with this PROJECT.md AND the instructions at the top of `CLAUDE.md` (structure, architecture, API reference, conventions, env vars).
