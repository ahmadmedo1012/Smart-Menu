...
async function main() {
  ...
  const plans = [
    ...
    { name: "Basic",   nameAr: "أساسي",     price: 29,  maxMenus: 1,  maxItems: 50,   maxOrders: 500,  sortOrder: 2, features: JSON.stringify(["منيو رقمي", "50 صنف", "طلقات غير محدودة", "برنامج ولاء", "تقرير شهري", "دعم فني"]) },
