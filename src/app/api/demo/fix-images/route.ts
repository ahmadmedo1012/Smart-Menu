...
const FIX_IMAGES: Record<string, string> = {
	...
	سموثي: 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba',
	...
	كنافة: 'https://images.unsplash.com/photo-1551024601-bec78aea704b',
	كريب: 'https://images.unsplash.com/photo-1509365465985-25d11c17e812',
	بسبوسة: 'https://images.unsplash.com/photo-1509365465985-25d11c17e812',
	ساندويتش: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af',
	'بطاطس مقلية': 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877',
	سلطة: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd',
	برجر: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd',
	بازين: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836',
	'بازين (مطبوخ)': 'https://images.unsplash.com/photo-1504674900247-0877df9cc836',
	مبكبكة: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836',
	كُسكُسي: 'https://images.unsplash.com/photo-1506084868230-bb9d95c24759',
	كسكسي: 'https://images.unsplash.com/photo-1506084868230-bb9d95c24759',
...
export async function POST() {
	try {
		...
		// Auth inside try/catch — a failed session lookup must return a clean
		// 401 via handleError, not an unhandled rejection → 500.
		...
		const items = await prisma.menuItem.findMany({
			where: { category: { is: { restaurantId: demoRestaurant.id } } },
		...
		for (const item of items) {
			...
			if (img) {
				...
				const catFallbacks: Record<string, string> = {
					...
					'وجبات خفيفة': 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd',
				};
				const fallback =
					catFallbacks[item.category?.name || ''] ||
					'https://images.unsplash.com/photo-1504674900247-0877df9cc836';
				try {
					await prisma.menuItem.update({
						where: { id: item.id },
						data: { image: fallback + '?w=400&q=85' },
					});
					skipped++;
				} catch {
					errors++;
