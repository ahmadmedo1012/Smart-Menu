...
export async function GET() {
  ...
  if (cats.length === 0) {
    ...
    await prisma.menuItem.createMany({ data: [
      { name: "قهوة تركي", price: 3, categoryId: hot.id, sortOrder: 1, image: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&q=85" },
      { name: "إسبريسو", price: 4, categoryId: hot.id, sortOrder: 2, image: "https://images.unsplash.com/photo-1504630083234-14187a9df0f5?w=400&q=85" },
      { name: "كابتشينو", price: 5, categoryId: hot.id, sortOrder: 3, image: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=85" },
      { name: "شاي", price: 2, categoryId: hot.id, sortOrder: 4, image: "https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=400&q=85" },
      { name: "ليموناضة", price: 4, categoryId: cold.id, sortOrder: 1, image: "https://images.unsplash.com/photo-1544145945-f90425340c7e?w=400&q=85" },
      { name: "سموثي", price: 6, categoryId: cold.id, sortOrder: 2, image: "https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=400&q=85" },
      { name: "موهيتو", price: 5, categoryId: cold.id, sortOrder: 3, image: "https://images.unsplash.com/photo-1505252585461-04db1eb84625?w=400&q=85" },
      ...
      { name: "تشيز كيك", price: 7, categoryId: sweets.id, sortOrder: 1, image: "https://images.unsplash.com/photo-1551024601-bec78aea704b?w=400&q=85" },
      { name: "كنافة", price: 6, categoryId: sweets.id, sortOrder: 2, image: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&q=85" },
      { name: "كريب", price: 5, categoryId: sweets.id, sortOrder: 3, image: "https://images.unsplash.com/photo-1509365465985-25d11c17e812?w=400&q=85" },
      { name: "بسبوسة", price: 4, categoryId: sweets.id, sortOrder: 4, image: "https://images.unsplash.com/photo-1482049016688-2d3e1b311543?w=400&q=85" },
      ...
      { name: "سلطة", price: 4, categoryId: snacks.id, sortOrder: 3, image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&q=85" },
