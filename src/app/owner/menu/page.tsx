      ...
      <Dialog open={catDialog} onOpenChange={setCatDialog}>
        <DialogContent className="rounded-2xl">
          ...
          <div className="space-y-4">
            <div><label className="text-sm font-medium">الاسم</label><input value={catForm.name} onChange={e => setCatForm({...catForm, name: e.target.value})} placeholder="مشروبات ساخنة" className="w-full h-11 rounded-xl border border-border/30 px-4 text-sm outline-none mt-1.5 focus-visible:border-amber-300" /></div>
