  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-xl mx-auto">
      ...
      <div className="rounded-2xl bg-card/50 border border-border/30 overflow-hidden">
        {/* Restaurant info */}
        <div className="flex items-center gap-3 p-5 border-b border-border/20 bg-gradient-to-l from-amber-50/30 to-transparent dark:from-amber-950/10">
            ...
            <div className="relative group">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="size-12 md:size-16 rounded-2xl bg-white/90 dark:bg-gray-900/90 shadow-lg flex items-center justify-center backdrop-blur-sm">
                  <Store className="size-6 md:size-8 text-amber-500" />
                </div>
              </div>
            </div>
          ) : (
        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            ...
            <div className="flex gap-2 mt-1.5">
              ...
              <Button variant="outline" size="icon" onClick={copy} className="size-11 rounded-xl shrink-0">
          ...
          <div className="flex items-center gap-2 p-4 rounded-xl bg-gradient-to-r from-amber-500/5 to-amber-600/5 border border-amber-200/20">
