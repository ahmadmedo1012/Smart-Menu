...
export default function PrivacyError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => { logError(error?.message || "Privacy page client error") }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 animate-fade-in">
      ...
      <p className="text-muted-foreground text-center max-w-md mb-6">تعذر تحميل سياسة الخصوصية. قد يكون هناك خلل مؤقت.</p>
