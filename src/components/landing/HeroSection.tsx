...
export default function HeroSection() {
    ...
    return (
        <section style={{ backfaceVisibility: "hidden" }} className="relative min-h-[85dvh] flex items-center justify-center overflow-hidden bg-background">
            ...
            {/* Ambient glow */}
            <div
                className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[70vmin] rounded-full pointer-events-none z-0"
                style={{
            ...
            <div className="relative z-10 w-full max-w-[1220px] mx-auto px-4 sm:px-6 text-center pt-12 sm:pt-16 pb-8">
                {/* Hero image — device mockup style */}
                <motion.div
                    initial={{ opacity: 0, y: 50, scale: 0.96 }}
                    animate={{ opacity: 1, y: 0, scale: 1 }}
                    transition={{ ...springGentle, delay: 0.08 }}
                    className="relative max-w-[820px] mx-auto mb-8 sm:mb-10 px-2 sm:px-4"
                >
                    {/* Image frame with rounded corners + shadow */}
                    <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-[0_8px_40px_-12px_rgba(0,0,0,0.3)] dark:shadow-[0_8px_40px_-12px_rgba(0,0,0,0.6)] ring-1 ring-foreground/5">
                        <OptimizedImage
                            src="/main21.png"
                    ...
                    {/* Soft floor glow */}
                    <div className="absolute -bottom-5 left-[15%] right-[15%] h-10 blur-3xl bg-orange/10 dark:bg-orange/15 rounded-full pointer-events-none" />
                </motion.div>
