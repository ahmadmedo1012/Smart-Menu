			...
			<div className="max-w-[1220px] mx-auto px-4">
				<div className="max-w-3xl mx-auto">
					...
					<div className="space-y-3">
						{FAQ_ITEMS.map((faq, i) => (
							<motion.details key={i} {...fadeUp(i * 0.5)} className="group rounded-md bg-card border border-border open:border-orange/30 open:shadow-md transition-all duration-300 overflow-hidden">
								<summary className="flex items-center justify-between cursor-pointer text-base font-medium list-none px-5 py-4 hover:text-orange transition-colors [&::-webkit-details-marker]:hidden">
									{faq.q}
