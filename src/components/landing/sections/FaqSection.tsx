...
const FAQS = [
  { q: "هل موقع المنيو الرقمي مجاني؟", a: "نعم، يوجد خطة مجانية للأبد مع ميزات أساسية. يمكنك الترقية إلى خطة مدفوعة للحصول على ميزات إضافية مثل أصناف غير محدودة وإحصائيات متقدمة." },
