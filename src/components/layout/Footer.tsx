					...
					<div className="md:col-span-2">
						...
						<div className="flex gap-3">
							...
							<a href="#" className="size-9 rounded-[6px] bg-white/5 flex items-center justify-center hover:bg-orange/20 transition-colors" aria-label="يوتيوب">
									<svg className="size-4 text-muted-foreground group-hover:text-orange transition-colors" viewBox="0 0 24 24" fill="currentColor"><path d="M23.5 6.19a3.02 3.02 0 0 0-2.12-2.14C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.38.55A3.02 3.02 0 0 0 .5 6.19 31.6 31.6 0 0 0 0 12a31.6 31.6 0 0 0 .5 5.81 3.02 3.02 0 0 0 2.12 2.14c1.88.55 9.38.55 9.38.55s7.5 0 9.38-.55a3.02 3.02 0 0 0 2.12-2.14A31.6 31.6 0 0 0 24 12a31.6 31.6 0 0 0-.5-5.81zM9.55 15.57V8.43L15.82 12l-6.27 3.57z"/></svg>
								</a>
							<a href="https://wa.me/218911111111" className="size-9 rounded-[6px] bg-white/5 flex items-center justify-center hover:bg-orange/20 transition-colors" aria-label="واتساب"><MessageCircle className="size-4 text-muted-foreground hover:text-orange transition-colors" /></a>
						</div>
					</div>
