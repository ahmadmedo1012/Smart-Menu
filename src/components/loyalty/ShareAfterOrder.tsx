...
export function ShareAfterOrder({
	orderNo,
	open,
	onOpenChange,
	restaurantSlug,
					...
					{step === 'phone' && (
						<>
							...
							<div className="text-center">
								...
								<p className="text-base font-semibold mb-1">ادع صديق وكل منكما يحصل على خصم 10٪</p>
								<p className="text-sm text-muted-foreground">
									أدخل رقم هاتفك لتفعيل برنامج الولاء والحصول على رابط الإحالة
								</p>
							</div>
					...
					{step === 'referral' && referralCode && (
						<div className="space-y-5 animate-fade-in">
							...
							<div>
								<label
									htmlFor="shareafter-phone"
									className="block text-xs font-medium text-muted-foreground mb-1.5 text-center"
								>
