...
const adminActions: Action[] = [
	{
		id: 'admin-dash',
		label: 'لوحة التحكم',
		icon: <LayoutDashboard className="size-4 text-orange" />,
		href: '/admin',
		keywords: ['admin', 'dashboard', 'رئيسية'],
	},
	{
		id: 'admin-restaurants',
		label: 'المطاعم',
		icon: <Store className="size-4 text-orange" />,
		href: '/admin/restaurants',
		keywords: ['restaurants', 'مطاعم'],
	},
	{
		id: 'admin-users',
		label: 'المستخدمون',
	...
	},
	{
		id: 'admin-menu',
		label: 'المينيو',
		icon: <UtensilsCrossed className="size-4 text-orange" />,
		href: '/admin/menu',
		keywords: ['menu', 'منيو', 'items'],
	},
	{
		id: 'admin-orders',
		label: 'الطلبات',
		icon: <ScrollText className="size-4 text-orange" />,
		href: '/admin/orders',
	...
	},
	{
		...
		label: 'المدفوعات',
		icon: <DollarSign className="size-4 text-orange" />,
		href: '/admin/subscriptions',
		keywords: ['payments', 'مدفوعات', 'اشتراكات'],
	},
	{
		id: 'admin-telegram',
		label: 'التليجرام',
	...
	},
	{
		id: 'admin-audit',
		label: 'سجل التدقيق',
		icon: <Activity className="size-4 text-orange" />,
		href: '/admin/audit-logs',
		keywords: ['audit', 'تدقيق'],
	},
	{
		id: 'admin-settings',
		label: 'الإعدادات',
		icon: <Settings className="size-4 text-orange" />,
		href: '/admin/settings',
...
const ownerActions: Action[] = [
	{
		...
		icon: <LayoutDashboard className="size-4 text-orange" />,
		href: '/owner',
		keywords: ['dashboard', 'owner', 'رئيسية'],
	},
	{
		id: 'owner-orders',
		label: 'الطلبات',
		icon: <ClipboardList className="size-4 text-orange" />,
		href: '/owner/orders',
		keywords: ['orders', 'owner', 'طلبات'],
	},
	{
		id: 'owner-menu',
		label: 'المنيو',
		icon: <Package className="size-4 text-orange" />,
		href: '/owner/menu',
		keywords: ['menu', 'owner', 'منيو'],
	},
	{
		id: 'owner-qr',
		label: 'رمز QR',
	...
	},
	{
		id: 'owner-loyalty',
		label: 'الولاء',
		icon: <Gift className="size-4 text-orange" />,
		href: '/owner/loyalty',
		keywords: ['loyalty', 'ولاء', 'نقاط'],
	},
	{
		id: 'owner-settings',
		label: 'الإعدادات',
		icon: <Settings className="size-4 text-orange" />,
		href: '/owner/settings',
		keywords: ['settings', 'owner', 'إعدادات'],
	},
];

// All actions merged, deduped by href
const allActions = [...adminActions, ...ownerActions].filter(
				...
				{open && (
					...
					>
						...
						>
							...
							<div
								ref={listRef}
								className="max-h-72 overflow-y-auto p-2 space-y-0.5 scrollbar-thin"
								role="listbox"
										...
										{filtered.map((action, i) => {
											...
											return (
												...
												>
													...
													{/* Active page badge */}
													{isActive && (
														<span className="relative z-10 ms-auto text-[10px] text-muted-foreground/40">
															الحالية
														</span>
													)}
												</button>
