...
export const fadeUp: Variants = { hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: easeOutQuart } }
export const fadeUpSpring: Variants = { hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: springGentle } }
export const scaleFade: Variants = { hidden: { opacity: 0, scale: 0.92 }, visible: { opacity: 1, scale: 1, transition: springDefault } }
export const tiltIn: Variants = { hidden: { opacity: 0, rotateX: -10, y: 30, scale: 0.95 }, visible: { opacity: 1, rotateX: 0, y: 0, scale: 1, transition: { type: "spring", stiffness: 200, damping: 20 } } }
export const slideLeft: Variants = { hidden: { opacity: 0, x: 40 }, visible: { opacity: 1, x: 0, transition: easeOutQuart } }
export const slideUpScale: Variants = { hidden: { opacity: 0, y: 60, scale: 0.9 }, visible: { opacity: 1, y: 0, scale: 1, transition: { type: "spring", stiffness: 150, damping: 16 } } }
export const cardHover: TargetAndTransition = { scale: 1.03, y: -8, transition: { type: "spring", stiffness: 300, damping: 18 } }
